...
if texto_1[0] > texto_2[0]:
    print('La primera letra de', texto_1, 'es mayor')
else:
    print('La primera letra de', texto_1, 'no es mayor a la de', texto_2)
...
if copia_texto_1 == texto_1:
    print('La primera palabra y su copia son iguales')

# Verifique que copia_texto_1 es distinta a texto_2
# Imprima en pantalla según corresponda

if copia_texto_1 != texto_2:
    print('La segunda palabra y la copia de la primera palabra son distintas')
